  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.26);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">智慧乡村旅游服务平台小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="手机号" class="input" v-if="tableName=='shangjia'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`yonghu` == this.tableName && this.ruleForm.zhanghao&&(!this.$validate.isMobile(this.ruleForm.zhanghao))){
        this.$message.error(`账号应输入手机格式`);
        return
      }
