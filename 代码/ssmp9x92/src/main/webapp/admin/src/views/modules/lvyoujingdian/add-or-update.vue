<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="营业时间" prop="yingyeshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.yingyeshijian" 
                type="datetime"
                placeholder="营业时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yingyeshijian" label="营业时间" prop="yingyeshijian">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jingdianjieshao = this.ruleForm.jingdianjieshao.replace(reg,'../../../ssmp9x92/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
